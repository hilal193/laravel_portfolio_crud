...
<div class="sidebar-container mt-10 pt-10">
    ...
    <ul class="sidebar-navigation">
      ...
      <li>
        <a href="{{route('contact.create')}}">
            <i class="fa fa-home" aria-hidden="true"></i> Contact -form
        </a>
    </li>
    <li>
    ...
    <ul class="sidebar-navigation">
        ...
        <li>
            <a href="{{route('skills.index')}}">
                {{-- <a href="#"> --}}
              <i class="fa fa-tachometer" aria-hidden="true"></i> Mes Skills
            </a>
        </li>
        <li>
  ...
  <div class="content-container">
    ...
    <h2 class="sub-header">Dashboard</h2>
              <h3>Contact :</h3>
              <p> ADD Project :  <a href="{{route('contact.create')}}" class="btn btn vert pt-1 m-1">+ADD</a>
              </p>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->description }}</td>
                             ...
                             <td class="df">
                            <a href="{{route('contact.show', $item->id)}}" class="btn btn vert">Show</a>
                            <a href="{{route('contact.edit', $item->id)}}" class="btn btn orange edit">Edit</a>
